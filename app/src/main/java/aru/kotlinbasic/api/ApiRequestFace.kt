...
class ApiRequestFace<T>(private val activity: Activity, objectType: T, private val TYPE: Int,
...
//            }
                ...
                when {
                    ...
                    {
                        if (error.message.username != null)
                            Toast.makeText(activity, error.message.username!!, Toast.LENGTH_SHORT).show()
                        else if (error.message.email!=null)
                            Toast.makeText(activity, error.message.email!!, Toast.LENGTH_SHORT).show()
                        else if (error.message.mobile!=null)
                            Toast.makeText(activity, error.message.mobile!!, Toast.LENGTH_SHORT).show()
                        else
